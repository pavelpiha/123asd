...
function createBasePullRequestPrompt(styleGuide, pullRequestDetails) {
  ...
  - Provide a bullet point list of violated rules exactly as it appears in the Style Guide followed by the <status>. ':x:'- if rule is violated; ':thinking:' - if you are unsure
